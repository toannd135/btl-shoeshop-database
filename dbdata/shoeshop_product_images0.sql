...
CREATE TABLE `product_images` (
  ...
  CONSTRAINT `FK7duksvvesmxhelrq7ugqkaq8b` FOREIGN KEY (`product_variant_id`) REFERENCES `product_variants` (`product_variant_id`),
...
-- Dump completed on 2026-03-04 23:13:14
