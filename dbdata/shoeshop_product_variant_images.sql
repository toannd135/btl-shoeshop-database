...
CREATE TABLE `product_variant_images` (
  ...
  KEY `FKk3x4ac0ubp5qcjicfm4nm35sy` (`product_variant_id`),
  CONSTRAINT `FKk3x4ac0ubp5qcjicfm4nm35sy` FOREIGN KEY (`product_variant_id`) REFERENCES `product_variants` (`product_variant_id`)
